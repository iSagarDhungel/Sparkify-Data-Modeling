...
# Configuration for redshift server
...
# FACT TABLE
# entities: songplay_id, start_time, user_id, level, song_id, artist_id, session_id, location, user_agent
...
# DIMENSION TABLE
# entities: user_id, first_name, last_name, gender, level
...
# entities: song_id, title, artist_id, year, duration
